...
const Blogs = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-142px)]">
      <section className=" text-gray-100 my-5">
        <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 rounded-md">
          <Link
            to={`/blog/${blogs[0]?.id}`}
            className="block rounded-md max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-900"
          >
            <img
